      ...
      <div class="signin-signup">
        <form action="" class="sign-in-form">
          ...
          <div class="input-field">
            ...
            <input type="tepasswordxt" placeholder="Hasło" />
          </div>
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          ...
          <p>Dołącz już teraz, aby móc zapisywać się na rekolekcje online.</p>
          <button @click="signInMode" class="btn transparent" id="sign-up-btn">
            Rejestracja
          </button>
        </div>
        <img src="../assets/oaza.svg" class="image" alt="" />
      </div>
      <div class="panel right-panel">
        <div class="content">
          <h3>Posiadasz już konto?</h3>
          <p>Zaloguj się używając swoich danych.</p>
          <button @click="signUpMode" class="btn transparent" id="sign-in-btn">
            Logowanie
          </button>
        </div>
        <img src="../assets/oaza.svg" class="image" alt="" />
